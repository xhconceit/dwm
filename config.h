...
static const Bool viewontag         = True;     /* Switch view on tag switch 是否开启移动窗口时自动跳转标签 */
...
static const char *dmenucmd[] = { "dmenu_run", "-i", "-c", "-g", "1", "-l", "10", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
...
static Key keys[] = {
	...
	// 减小亮度
	{ Mod1Mask,                     XK_F11,    spawn,          {.v = lightDown} },
	// 扩大声音
	{ Mod1Mask,                     XK_F3,     spawn,          {.v = volUp} },
	// 降低声音
	{ Mod1Mask,                     XK_F2,     spawn,          {.v = volDown} },
	// 开关声音
	{ Mod1Mask,                     XK_F1,     spawn,          {.v = volToggle} },
	// 重启 dwm
